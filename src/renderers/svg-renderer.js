...
class SVGRenderer {
    ...
    <g transform="translate(80, 45)">
      ...
      <text x="0" y="20" fill="${theme.subText}" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-size="12">${totalModels} Models • ${totalRelations} Relationships • Generated by schemagraph-core</text>
    </g>`;
